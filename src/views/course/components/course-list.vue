  ...
  <div class="course-list">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="price" label="操作" width="280" align="center">
          <template slot-scope="scope">
            <el-button @click="goCourseEdit(scope.row)">编辑</el-button>
            <el-button @click="goCourseSection(scope.row)">内容管理</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
