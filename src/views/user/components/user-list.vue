<template>
  <el-card>
    ...
    <el-table :data="users" style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="name" label="头像" min-width="80">
        <template slot-scope="scope">
          <img
            width="30px"
            :src="scope.row.portrait || require('@/assets/avator-default.png')"
          />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="name" label="状态" min-width="80">
        <template slot-scope="scope">
          <el-switch
    ...
    <el-dialog title="分配角色" :visible.sync="dialogVisible" min-width="50%">
